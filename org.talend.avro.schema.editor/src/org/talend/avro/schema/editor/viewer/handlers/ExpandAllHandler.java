...
public class ExpandAllHandler extends ContextualHandler {

	public static final String CMD_ID = "org.talend.avro.schema.editor.viewer.ExpandAll"; //$NON-NLS-1$
	...
	protected void doExecute(ExecutionEvent event, AvroSchemaEditor schemaEditor, AvroContext context) {		
		...
		UIUtils.expandAll(viewer, CMD_ID);		
	}
